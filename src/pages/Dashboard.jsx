import { FilePenLineIcon, Pencil, Plus, Trash, UploadCloud, XIcon } from 'lucide-react'
...
const Dashboard = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto px-4 py-8'>
      <p className='text-2xl font-medium mb-6 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent sm:hidden'>
        Welcome, Aashish Badal
      </p>
        ...
        {allResumes.map((resume, index) => {
          ...
          return (
            <button
              ...
              style={{
                background: `linear-gradient(135deg,${baseColor}30,${baseColor}80)`,
      ...
      {showCreateResume && (
        ...
        >
          ...
          >
            ...
            <input onChangeCapture={(e)=>setTitle(e.target.value) } value={title}
              type='text'
